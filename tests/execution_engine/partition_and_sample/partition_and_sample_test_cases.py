...
SINGLE_DATE_PART_BATCH_IDENTIFIERS: List[pytest.param] = [
    ...
    pytest.param(
        datetime.datetime(2018, 10, 31, 0, 0, 0),  # noqa: DTZ001 # FIXME CoP
        id="datetime",
    ),
    pytest.param(
    ...
    pytest.param(
        datetime.datetime(2018, 11, 30, 0, 0, 0),  # noqa: DTZ001 # FIXME CoP
        marks=pytest.mark.xfail(strict=True),
...
MULTIPLE_DATE_PART_BATCH_IDENTIFIERS: List[pytest.param] = [
    ...
    pytest.param("10-31-2018", id="dateutil parseable date string"),
    pytest.param(
        datetime.datetime(2018, 10, 30, 0, 0, 0),  # noqa: DTZ001 # FIXME CoP
        id="datetime",
    ),
    pytest.param(
