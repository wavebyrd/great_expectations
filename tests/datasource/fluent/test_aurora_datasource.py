...
@pytest.mark.unit
def test_add_aurora_datasource(
    mock_test_connection,
    empty_data_context: AbstractDataContext,
):
    test_datasource_name = "test_datasource"
    test_connection_string = "postgresql://username:@cluster_endpoint.amazonaws.com:/database_name"
    source = empty_data_context.data_sources.add_aurora(
