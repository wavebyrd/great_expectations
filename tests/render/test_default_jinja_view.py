    ...
    validation_results = ExpectationSuiteValidationResult(
        **{
            ...
            "meta": {
                ...
                "batch_kwargs": {
                    "path": "/Users/user/project_data/public_healthcare_datasets/tetanusvaricella/tetvardata.csv",  # noqa: E501 # FIXME CoP
...
</div>""".replace(" ", "")  # noqa: E501 # FIXME CoP
        .replace("\t", "")
        .replace("\n", "")
    )
