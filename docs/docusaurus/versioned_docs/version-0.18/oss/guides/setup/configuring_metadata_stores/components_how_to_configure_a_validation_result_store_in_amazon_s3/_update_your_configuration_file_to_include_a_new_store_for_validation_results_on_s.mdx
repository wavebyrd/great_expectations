...
```python title="Python" name="docs/docusaurus/docs/snippets/aws_cloud_storage_pandas.py new_validations_store"
```
...
```python title="Python" name="docs/docusaurus/docs/snippets/aws_cloud_storage_pandas.py set_new_validations_store"
```
