...
```python title="Python" name="empty batch_spec_passthrough"
```
...
```python title="Python" name="set reader_method to csv"
```
...
```python title="Python" name="empty keys for reader_options"
```
...
```python title="Python" name="populate header for reader_options as True"
```
...
```python title="Python" name="populate inferSchema for reader_options as True"
```
...
```python title="Python" name="fully populated batch_spec_passthrough configuration"
```