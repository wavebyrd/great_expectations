    ...
    <>
      ...
      {!feedbackSent && <section className={styles.feedbackCard}>
        ...
        <div className={styles.feedbackCardActions}>
          <button
            disabled={feedbackSent} className={styles.feedbackButton}
            onClick={() => handleFeedbackReaction('docs_feedback.yes')}
          >Yes
          </button>
          <button
            disabled={feedbackSent} className={styles.feedbackButton}
            onClick={handleNegativeFeedbackReaction}
          >No
          </button>
        </div>
                        </section>}
      ...
      {isOpen && <>
        ...
        <dialog className={styles.modal}>
          <section className={styles.modalHeader}>
            ...
            <img
              src={closeImg} className={styles.modalHeaderCloseButton}
          ...
          <form onSubmit={sendReview} className={styles.modalContent}>
            ...
            <div>
              <label className={styles.radioOption}>
                <input
                  type='radio' name='selectedValue' value='language-typo'
            ...
            <div>
              <label className={styles.radioOption}>
                <input
                  type='radio' name='selectedValue' value='inaccurate'
            ...
            <div>
              <label className={styles.radioOption}>
                <input
                  type='radio' name='selectedValue' value='code-sample-errors'
            ...
            <div>
              <label className={styles.radioOption}>
                <input
                  type='radio' name='selectedValue' value='need-gx-support'
            ...
            <input
              type='submit' disabled={!formData.description} className={styles.submitButton}
              value='Submit'
            />
          </form>
        </dialog>
