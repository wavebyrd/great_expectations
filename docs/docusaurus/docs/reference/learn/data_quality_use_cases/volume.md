...
GX provides several Expectations specifically designed for managing data volume, all of which can be added directly in GX Cloud or GX Core. Some of them can be automatically generated by enabling Anomaly Detection when you add a new Data Asset using GX Cloud.
